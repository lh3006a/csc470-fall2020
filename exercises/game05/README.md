...
...* How to get the computer to recognize if two animals are the same if they are randomly placed on the plane
.....* Maybe have the user click on both of the animals once they are revealed from under the boxes and 		check the tags 
..* How to get the box to disappear so that the user can see the animal underneath it
..* How to randomly place animals under boxes on a plane
